...
export function GameOverScreen() {
  ...
  const isWinner = state.nickname === winner;
  const titleText = isWinner ? 'YOU WON!' : 'GAME OVER';
  const titleClass = isWinner ? 'gameover-title winner-title' : 'gameover-title';

  return makeElement('div', { class: 'gameover-screen' }, [
    makeElement('div', { class: 'gameover-box' }, [

      makeElement('h1', { class: titleClass }, titleText),
